function useDate(){
    ...
    const newDateFormat = (stripeDate) => {
        ...
        return [dayMonth, day, createdDateFormat, fullDate] 
    }

    const nonStripeDateFormat = () => {
        ...
        return [nonStripeDayMonth, nonStripeDay, nonStripeCreatedDateFormat, nonStripeFullDate] 
    }

    return { newDateFormat, nonStripeDateFormat }
}
