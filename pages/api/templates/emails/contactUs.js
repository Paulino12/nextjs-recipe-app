            ...
            <mj-body background-color="#ffffff">
                ...
                <mj-section background-color="#f5f5f4" padding-bottom="20px" padding-top="20px">
                    <mj-column vertical-align="middle" width="100%">
                        ...
                        <mj-text align="left" color="#000" font-size="15px" font-family="open Sans Helvetica, Arial, sans-serif" padding-left="25px" padding-right="25px">Thanks for contacting us. We will be in touch shortly...</mj-text>
